...
Route::group(
    [
        ...
        'middleware' => array_merge(
            ...
            (array) config('backpack.base.custom_middleware.ensure_admin', 'ensure_admin')
...
// Regroupement de routes avec un namespace personnalisé
Route::group(
    [
        'namespace' => 'App\Http\Controllers\Admin\Auth', // Change le namespace ici
        'middleware' => array_merge(
            (array) config('backpack.base.web_middleware', 'web'),
        ),
        'prefix' => config('backpack.base.route_prefix'),
    ...
    function () {
        ...
        Route::get('logout', 'AdminLoginController@logout')->name('backpack.auth.logout');
