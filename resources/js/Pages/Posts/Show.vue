       ...
       <template #header>
        ...
        <div class="flex items-center justify-center py-32">
            <div class="max-w-7xl  mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 w-2/3">
              ...
              <div class="col-span-full relative md:col-span-1 w-full bg-white shadow-md rounded-lg overflow-hidden">
    <div class="px-6 py-4 bg-gray-100">
        <h2 class="text-xl font-semibold text-pink-900">Commentaires</h2>
    </div>
    <!-- Section des commentaires avec une hauteur maximale et un overflow pour permettre le scroll -->
    <div class="p-6 overflow-y-auto max-h-[400px] h-[400px]">
