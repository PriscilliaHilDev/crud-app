                        ...
                        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                          <PopoverGroup class="hidden lg:flex lg:gap-x-12 mx-8">
                            <Popover class="relative">
                              <PopoverButton class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-slate-100 bg-pink-900 rounded-full px-3 py-1 border-none focus:outline-none">
                                  Catégories
                                  <ChevronDownIcon class="h-5 w-5 flex-none text-slate-100" aria-hidden="true" />
                              </PopoverButton>
                              <transition
